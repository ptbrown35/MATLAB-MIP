...
1) Install R2017b MATLAB (or newest) and Simulink. Make sure to Install Embedded coder.
...
5) copy the following files
	1) Copy the contents of +beagleboneblue folder to 'location/+beagleboneblue'
	2) Copy the .h files to 'location/include'
	3) Copy the .c files to 'location/src'
6) In the MATLAB command line execute
	>> rehash toolboxcache
7) To view the bbblue library blocks, type 'beaglebonebluelib' in command line to open the lib.
