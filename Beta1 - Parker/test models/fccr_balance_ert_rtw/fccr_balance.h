...
typedef struct {
  ...
  real_T DiscreteFilter1_states;       /* '<Root>/Discrete Filter1' */
  struct {
    void *LoggedData;
...
struct P_fccr_balance_T_ {
  ...
  real_T DiscreteFilter_NumCoef;       /* Expression: [1]
                                        ...
                                        */
  real_T DiscreteFilter_DenCoef[2];    /* Expression: [1 0.01]
                                        * Referenced by: '<Root>/Discrete Filter'
                                        */
  ...
  real_T DiscreteFilter1_NumCoef;      /* Expression: [1]
                                        ...
                                        */
  real_T DiscreteFilter1_DenCoef[2];   /* Expression: [1 0.01]
                                        * Referenced by: '<Root>/Discrete Filter1'
                                        */
 ...
 * '<S2>'   : 'fccr_balance/Degrees to Radians'
 * '<S3>'   : 'fccr_balance/Radians to Degrees'
 * '<S4>'   : 'fccr_balance/Slider D1_GAIN'
 * '<S5>'   : 'fccr_balance/Slider D2_GAIN'
 */
