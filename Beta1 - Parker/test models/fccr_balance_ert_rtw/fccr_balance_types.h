...
#ifndef typedef_cell_wrap_fccr_balance_T
#define typedef_cell_wrap_fccr_balance_T

typedef struct {
  uint32_T f1[8];
} cell_wrap_fccr_balance_T;

#endif                                 /*typedef_cell_wrap_fccr_balance_T*/
...
typedef struct {
  int32_T isInitialized;
  cell_wrap_fccr_balance_T inputVarSize;
